...
if (loginForm) {
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      console.log('User type from response:', user.user_type);
      ...
      // Clear the isLoggingIn flag before redirect
...
async function initEdit() {
  ...
  try {
    ...
    if (preview && bread.image_path) {
      ...
      const spinner = preview.parentElement?.querySelector('.image-loading-spinner');
