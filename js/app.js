...
if (loginForm) {
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        console.log('Redirecting to', redirectUrl, 'now...');
        console.log('About to redirect to:', window.location.origin + '/' + redirectUrl);
...
window.addToCartFromDetail = addToCartFromDetail;// frontend/app.js
